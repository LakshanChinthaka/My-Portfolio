...
function HeroSection() {
    ...
    return (
        <section className="bg-white dark:bg-gray-900 xl:mt-0 lg:mt-[-60px] lg:pl-10 flex sm:justify-center md:mt-10">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                ...
                <div className="mr-auto place-self-center lg:col-span-7 lg:mt-20">
                    ...
                    <div className="flex justify-center py-8 md:py-3">
                        ...
                        <a href="/project/Lakshan Chinthaka - CV.pdf" target="_Blank">
                            <DownloadBtn />
                        </a>
                ...
                <div className="mt-3 lg:col-span-10 md:mt-10 flex justify-center lg:ml-[180px] relative lg:justify-start gap-10 lg:mt-7 ">
                    <a href="www.linkedin.com/in/lakshan-chinthaka" target="_blank">

                        <FaLinkedin className="w-[35px] h-[35px] lg:w-[37px] lg:h-20 fill-gray-800 hover:fill-blue-700 dark:fill-gray-500" />
                    </a>

                    <a href="https://github.com/LakshanChinthaka" target="_blank">

                        <FaGithub className="w-[35px] h-[35px] lg:w-[42px] lg:h-20 fill-gray-800 hover:fill-black dark:fill-gray-500" />
                    </a>
                    <a href="https://www.facebook.com/chinthaka.lakshan.100?mibextid=ZbWKwL" target="_black">
                        <FaFacebookSquare className="w-[35px] h-[35px] lg:w-[40px] lg:h-20 fill-gray-800 dark:fill-gray-500 hover:fill-blue-700" />
                    </a>
                    <a href="https://www.instagram.com/lakshan_chinthaka_/?fbclid=IwAR3h8REZIPazU6VuFL6N1ljQo1MEV8CWDKuoVDNAZY1tXFDLFcJExyrBihU" target="_black">
                        <FaInstagram className="w-[35px] h-[35px] lg:w-[40px] lg:h-20 fill-gray-800 hover:fill-pink-500 dark:fill-gray-500" />
            ...
            {/* <motion.div
                ...
                initial="initial"
                animate="animate"
                className="abolute text-[10vh] bottom-[-540px] font-bold whitespace-nowrap text-gray-400 opacity-25">
                Java Springboot React.Js TailwindCss AWS Firebase JavaScript MySQL 
            </motion.div> */}
