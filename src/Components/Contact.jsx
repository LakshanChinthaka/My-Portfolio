...
function Contact() {
  ...
  <div class="py-3 mb-20 lg:py-2 px-4 mx-auto max-w-screen-md">
      <h1 className="text-gray-800 max-w-2xl xl:mt-[-50px]  mb-4  text-4xl font-extrabold  text-center tracking-tight leading-none md:text-4xl xl:text-[50px] lg:text-[40px] flex  justify-center  dark:text-white">Contact <h1 className="ml-3 text-[#fbb40c] animate-bounce">me.</h1></h1>
